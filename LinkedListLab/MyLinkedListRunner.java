public class MyLinkedListRunner {
    ...
    public static void test00constructorToString() {
        ...
        if ((a.size() == 0 && a.toString().equals("[]")) &&
            ...
            System.out.println("Pass: your constructor and toString seem to be working!");
        }
        else
            System.out.println("Fail: there's a problem with your constructor or toString.");
    }
    ...
    public static void test08removeAll() {
        ...
        if (list.size() == 0 && list.toString().equals("[]")) {
            ...
            System.out.println("Fail: there's a problem removing everything");
        }
    }
