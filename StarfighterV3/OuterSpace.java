...
public class OuterSpace extends Canvas implements KeyListener, Runnable
{
    ...
    public OuterSpace()
    {
        ...
        horde.add(new Alien(400, 100, 50, 50, 1));
        horde.add(new Alien(350, 50, 50, 50, 1));
        horde.add(new Alien(300, 100, 50, 50, 1));
        horde.add(new Alien(250, 50, 50, 50, 1));
        horde.add(new Alien(200, 100, 50, 50, 1));
        horde.add(new Alien(150, 50, 50, 50, 1));
        horde.add(new Alien(100, 100, 50, 50, 1));
        horde.add(new Alien(50, 50, 50, 50, 1));
